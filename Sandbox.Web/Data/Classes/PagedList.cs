using Sabio.Web.Core.Interfaces;
...
namespace Sandbox.Web
{
    public class PagedList<T>
    {
        ...
        public IPagedList<T1> Create<T1>(List<T1> data, int page, int pagesize)
        {
            return new PagedList<T1>(data, page, pagesize);
        }

        public IPagedList<T1> Create<T1>(List<T1> data, int page, int pagesize, int totalCount)
        {
            return new PagedList<T1>(data, page, pagesize, totalCount);
        }

        public IPagedList<T1> Create<T1>(List<T1> data, int pageCount)
        {
            return new PagedList<T1>(data, pageCount);
        }
    }
